...
const PasswordInput = ({ id, name, placeholder, value, onChange, required = false }) => {
    ...
    return (
        <div className="password-input-wrapper">
            <input
                ...
                required={required}
            />
            <button type="button" onClick={() => setShowPassword(!showPassword)} className="showhidepass-container">
                {showPassword ? (
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <path d="M11.297 9.176a3.5 3.5 0 0 0-4.474-4.474l.823.823a2.5 2.5 0 0 1 2.829 2.829l.822.822zm-2.943 1.284a3.5 3.5 0 0 1-4.474-4.474l.823.823a2.5 2.5 0 0 0 2.829 2.829l.822.822z"/>
