...
// Mock data is now centralized here
const initialFeedbackData = [
    { 
        id: 2, 
        user: 'Amit K.', 
        collegeId: 'U202112302',
        route: '7A', 
        busNo: 'KA-01-F-5678',
        issue: 'Driver Behavior', 
        status: 'Resolved',
        submittedOn: '2023-10-25T14:30:00Z',
        details: { punctuality: 'On Time', driverBehavior: 'Poor', cleanliness: 'Average' },
        comments: 'The driver was talking on the phone while driving and was very rude when a student asked him to stop.',
        attachmentName: 'video-of-driver.mp4',
        resolution: { resolvedBy: 'Admin User', resolvedOn: '2023-10-26T09:00:00Z', notes: 'Spoke with the driver and issued a warning. Monitoring their performance for the next month.' }
    },
    { 
        id: 1, 
        user: 'Priya S.', 
        collegeId: 'U202112301',
        route: '3B', 
        busNo: 'KA-01-F-1234',
        issue: 'Punctuality', 
        status: 'Pending',
        submittedOn: '2023-10-26T10:00:00Z',
        details: { punctuality: 'Very Late', driverBehavior: 'Good', cleanliness: 'Clean' },
        comments: 'The bus was over 30 minutes late this morning without any prior notification. This has happened multiple times this week.',
        attachmentName: ''
    },
];

// Centralize announcements data
...
const AppContent = () => {
  ...
  const noNavbarRoutes = ['/', '/signup', '/forgot-password', '/reset-password'];
